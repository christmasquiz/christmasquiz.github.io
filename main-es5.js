...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoveLetterComponent = /** @class */ (function () {
                ...
                LoveLetterComponent.prototype.createRemainingCardsSummary = function () {
                    ...
                    tempDeck.push.apply(tempDeck, __spread(this.player1.cards));
                    tempDeck.push.apply(tempDeck, __spread(this.player2.cards));
                    tempDeck.push.apply(tempDeck, __spread(this.player3.cards));
                    tempDeck.push.apply(tempDeck, __spread(this.player4.cards));
                    var tempSummary = [];
                ...
                LoveLetterComponent.prototype.addCardToPlayedCards = function (player, card) {
                    ...
                    (_a = player.playedCards).push.apply(_a, __spread(player.cards.splice(index, 1)));
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QuizRoundCrosswordComponent = /** @class */ (function () {
                ...
                QuizRoundCrosswordComponent.prototype.getRoundName = function () {
                    ...
                    this.activatedRoute.params.subscribe(function (param) {
                        _this.questions = new _shared_RoundInfo__WEBPACK_IMPORTED_MODULE_1__["RoundInfo"]().getCrosswordRoundQuestions(param['quizname']);
                    });
                };
            ...
            QuizRoundCrosswordComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QuizRoundImageComponent = /** @class */ (function () {
                ...
                QuizRoundImageComponent.prototype.getCurrentImageUrl = function () {
                    var url = this.questions[this.currentQuestion].url;
                    return url ? url : this.getLocalImgUrl();
                };
                QuizRoundImageComponent.prototype.getLocalImgUrl = function () {
            ...
            QuizRoundImageComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QuizRoundOverviewComponent = /** @class */ (function () {
                ...
                QuizRoundOverviewComponent.prototype.getPuzzleRoundOmschrijving = function (rondeNaam) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QuizRoundPuzzleComponent = /** @class */ (function () {
                function QuizRoundPuzzleComponent(activatedRoute, router) {
                    this.correctAnswers = [];
                    this.activatedRoute = activatedRoute;
                    this.router = router;
                }
                QuizRoundPuzzleComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.activatedRoute.params.subscribe(function (param) {
                        _this.roundName = param['quizname'];
                        _this.puzzleRound = new _shared_RoundInfo__WEBPACK_IMPORTED_MODULE_2__["RoundInfo"]().getPuzzleRound(_this.roundName);
                        _this.keywords = _this.chunkArray(_this.shuffleArray(_this.mapToKeywords()));
                    });
                };
                QuizRoundPuzzleComponent.prototype.mapToKeywords = function () {
                    return this.puzzleRound.questions.map(function (question) { return question.keywords; })
                        .flatMap(function (x) { return x; });
                };
                QuizRoundPuzzleComponent.prototype.shuffleArray = function (array) {
                    for (var i = array.length - 1; i > 0; i--) {
                        var j = Math.floor(Math.random() * (i + 1));
                        var temp = array[i];
                        array[i] = array[j];
                ...
                QuizRoundPuzzleComponent.prototype.chunkArray = function (myArray) {
                    var index = 0;
                ...
                QuizRoundPuzzleComponent.prototype.checkAnswer = function () {
                    if (this.isAnswerCorrect()) {
                        var questionCorrectlyAnswered = this.puzzleRound.questions[this.getCorrectAnswerIndex()];
                ...
                QuizRoundPuzzleComponent.prototype.isAnswerCorrect = function () {
                    return this.getCorrectAnswerIndex() > -1;
                };
                QuizRoundPuzzleComponent.prototype.getCorrectAnswerIndex = function () {
                    return this.puzzleRound.questions.map(function (q) { return q.answer; }).indexOf(this.currentGuess.toLowerCase());
                };
                QuizRoundPuzzleComponent.prototype.removeKeywords = function (keywordsToRemove) {
                    var _this = this;
                    keywordsToRemove.forEach(function (keywordToRemove) {
                        _this.keywords.forEach(function (keywordGroup) {
                            var indexOfKeywordToRemove = keywordGroup.indexOf(keywordToRemove);
                ...
                return QuizRoundPuzzleComponent;
            }());
            QuizRoundPuzzleComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QuizRoundQuestionComponent = /** @class */ (function () {
                ...
                QuizRoundQuestionComponent.prototype.ngOnInit = function () {
                    ...
                    this.activatedRoute.params.subscribe(function (param) {
                        _this.roundName = param['quizname'];
                        _this.vragen = new _shared_RoundInfo__WEBPACK_IMPORTED_MODULE_1__["RoundInfo"]().getClassicRoundQuestions(_this.roundName);
                    });
                };
            ...
            QuizRoundQuestionComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QuizRoundRodeDraadComponent = /** @class */ (function (_super) {
                ...
                QuizRoundRodeDraadComponent.prototype.ngOnInit = function () {
                    ...
                    this.activatedRoute.params.subscribe(function (param) {
                        _this.roundName = param['quizname'];
                        _this.vragen = new _shared_RoundInfo__WEBPACK_IMPORTED_MODULE_1__["RoundInfo"]().getRodeDraadRoundQuestions(_this.roundName);
                    });
                };
            ...
            }(_quiz_round_question_quiz_round_question_component__WEBPACK_IMPORTED_MODULE_2__["QuizRoundQuestionComponent"]));
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            QuizRoundSolvedComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RoundInfo = /** @class */ (function () {
                ...
                RoundInfo.prototype.initializePuzzleRounds = function () {
                ...
                RoundInfo.prototype.getPuzzleRoundOmschrijving = function (rondeNaam) {
                ...
                RoundInfo.prototype.getRoundNames = function (roundMap) {
                    return Array.from(roundMap, function (_a) {
                        var _b = __read(_a, 2), key = _b[0], value = _b[1];
                        var imgLocation = value.imgUrl ? value.imgUrl : key;
                        return {
                            roundName: key,
                            link: imgLocation,
                ...
                RoundInfo.prototype.getPuzzleRoundNames = function () {
                    return this.getRoundNames(this.puzzleRounds);
                };
                RoundInfo.prototype.getPuzzleRound = function (roundName) {
